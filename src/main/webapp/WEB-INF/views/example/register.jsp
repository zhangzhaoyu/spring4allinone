...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-offset-3 col-sm-6">
            <form:form id="authForm" modelAttribute="user" class="form-horizontal" action="${pageContext.request.contextPath}/example/handler27" method="POST">
                <form:errors path="*" />

                <div class="form-group">
                    <div class="col-sm-12">
                        <form:errors path="userName" cssClass="errorClass" />
                        <form:input path="userName" type="text" name="username" class="form-control" id="email" placeholder="Email" />
                    </div>
                    <div class="col-sm-12">
